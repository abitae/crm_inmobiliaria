    ...
    public function run(): void
    {
        ...
        $reservations = [
            [
                ...
                'notes' => 'Cliente pagó el 100% de la reserva. Excelente perfil crediticio.',
            ...
            [
                ...
                'notes' => 'Cliente VIP, pago en efectivo. Pendiente firma de documentos.',
                'terms_conditions' => 'Reserva válida por 30 días. Pago inicial del 10% del valor total.',
            ...
            [
                ...
                'notes' => 'Reserva confirmada. Cliente procederá con la compra en los próximos días.',
                'terms_conditions' => 'Reserva válida por 30 días. Pago inicial del 10% del valor total.',
                'client_signature' => true,
                'advisor_signature' => true,
            ],
            [
                ...
                'notes' => 'Empresa pagó el 60% de la reserva. Pendiente el 40% restante.',
                'terms_conditions' => 'Reserva válida por 30 días. Pago inicial del 10% del valor total.',
                'client_signature' => false,
                'advisor_signature' => true,
            ],
            [
                ...
                'notes' => 'Constructor interesado en desarrollo. Reserva firmada y pagada.',
                'terms_conditions' => 'Reserva válida por 30 días. Pago inicial del 10% del valor total.',
                'client_signature' => true,
                'advisor_signature' => true,
            ],
