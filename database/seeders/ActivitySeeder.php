    ...
    public function run(): void
    {
        ...
        $activities = [
            [
                ...
                'description' => 'Mostrar lote A-101 del proyecto Lotes Miraflores Park al cliente Juan Vargas.',
                'activity_type' => 'visita',
                'status' => 'programada',
                'priority' => 'alta',
                'start_date' => now()->addDays(2)->setTime(15, 0),
                'duration' => 90,
                'location' => 'Lotes Miraflores Park - Av. Arequipa 1234',
            ...
            [
                ...
                'description' => 'Presentación del proyecto Lotes Surco Family a Carmen Flores.',
