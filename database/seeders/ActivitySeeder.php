    ...
    public function run(): void
    {
        ...
        $activities = [
            [
                ...
                'opportunity_id' => $opportunities->where('client_id', $clients->where('email', 'juan.vargas@email.com')->first()->id)->first()->id,
            ...
            [
                ...
                'unit_id' => null,
                'opportunity_id' => $opportunities->where('client_id', $clients->where('email', 'maria.torres@email.com')->first()->id)->first()->id,
                'advisor_id' => $advisors->random()->id,
                'assigned_to' => $advisors->random()->id,
                'reminder_before' => 15,
                'reminder_sent' => true,
            ...
            [
                ...
                'unit_id' => null,
                'opportunity_id' => $opportunities->where('client_id', $clients->where('email', 'carmen.flores@email.com')->first()->id)->first()->id,
                'advisor_id' => $advisors->random()->id,
                'assigned_to' => $advisors->random()->id,
                'reminder_before' => 60,
                'reminder_sent' => false,
            ...
            [
                ...
                'unit_id' => null,
                'opportunity_id' => $opportunities->where('client_id', $clients->where('email', 'roberto.silva@empresa.com')->first()->id)->first()->id,
                'advisor_id' => $advisors->random()->id,
                'assigned_to' => $advisors->random()->id,
                'reminder_before' => 10,
                'reminder_sent' => true,
